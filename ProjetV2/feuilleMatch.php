				...
				<div class="col-sm-8">
					...
					<div class="row inputSelection">
						<div class="col-sm-6 selectionClub">
							...
							Club: <input type="text" name="club1" id="inputClub1" list="clubList" oninput="updateClub1()" onkeypress="return addClub1(event)" disabled>
						</div>
						<div class="col-sm-6 selectionClub">
							...
							Club: <input type="text" name="club2" id="inputClub2" list="clubList" oninput="updateClub2()" onkeypress="return addClub2(event)" disabled>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
